...
public class ManagementController2 {
	...
	public String management(Model model,
	     ...
	     if(category.equals("1")) {
	    	 ...
	    	 /* r_paging */
	         int count = m_service.r_PagingCountMng(map);
	    	 ...
	    	 return "/management_reseller";
	    	 
	     }else if(category.equals("2")) {
	    	 
	    	 /* c_paging */
		     int count = m_service.c_PagingCountMng(map);
		     Paging pageInfo = new Paging(count, pageNo, pageView);
		     model.addAttribute("pageInfo", pageInfo);
	    	 ...
	    	 /* g_paging */
		     int count = m_service.g_PagingCountMng(map);
		     Paging pageInfo = new Paging(count, pageNo, pageView);
		     model.addAttribute("pageInfo", pageInfo);
	  ...
	  @RequestMapping(value = "/reseller_managementExcel")
	   public void reseller_managementExcel(HttpServletResponse response,
	   		@RequestParam Map map
	   		) throws Exception {
		...
		// select M_reseller
			...
			m_service.reseller_managementExcel(response, T_RsellerList); 
	   	}
	  
	  
	   @RequestMapping(value = "/custom_managementExcel")
	   public void custom_managementExcel(HttpServletResponse response,
			   @RequestParam Map map
			   ) throws Exception {
		   ...
		   // select M_custumer
			...
			m_service.custom_managementExcel(response, T_CustomerList); 
	   }
	   ...
	   @RequestMapping(value = "/goods_managementExcel")
	   public void goods_managementExcel(HttpServletResponse response,
			   @RequestParam Map map
			   ) throws Exception {
		...
		// select M_goods
		   ...
		   m_service.goods_managementExcel(response, T_GoodsList); 
	   }
