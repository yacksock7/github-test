...
<script type="text/javascript">
   ...
   function doSearch(){
      ...
      window.form1.target = "";
      window.form1.action = "/management2";
      window.form1.submit();
   }
	// enter 시 조회
                   ...
                   <form id="form2" name="form2" method="POST" class="form-horizontal">
                     <div class="panel-body">
                        <div class="table-responsive">
                           <table id="reseller_management_table" 
               ...
               <div class="panel panel-default" id = "goods_div">
                  <div class="panel-heading">
                   ...
                   <form id="form4" name="form4" method="POST" class="form-horizontal">
                     ...
                     <div class="panel-body">
                        <div class="table-responsive">
                           <table id="goods_management_table" 
                              class="table table-bordered table-striped">
                              <thead>
                                 <tr>
                                 	<th>상품번호</th>
 ...
 $(document).ready(function() {
    ...
    /* 자동완성 */
 	var availableTags = new Array(); 
   	...
   	$("#reseller_management_table tr").click(function(){  
   	    // 현재 클릭된 Row(<tr>)
   	    var tr = $(this);
   	    var td = tr.children();
   		
   		$("#seller_id").val(td.eq(0).text()).prop("selected", true);
   		doSearch();
	});
   	$("#customer_management_table tr").click(function(){    
   		// 현재 클릭된 Row(<tr>)
   	    var tr = $(this);
   	    var td = tr.children();
   	    
   		$("#customer_id").val(td.eq(0).text()).prop("selected", true);
   		doSearch();
	});
   	$("#goods_management_table tr").click(function(){    
   		// 현재 클릭된 Row(<tr>)
   	    var tr = $(this);
   	    var td = tr.children();
   	    
   		$("#goods_nm").val(td.eq(1).text());
   		doSearch();
   	});
